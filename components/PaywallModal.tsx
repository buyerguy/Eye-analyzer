...
const PaywallModal: React.FC<PaywallModalProps> = ({ onUpgrade, onClose, scanCount }) => {
  ...
  return (
    ...
    >
      <div
        className="bg-white text-gray-800 rounded-3xl shadow-2xl w-full max-w-md relative overflow-hidden"
        onClick={(e) => e.stopPropagation()}
      >
        <div className="p-8">
            <h2 className="text-3xl font-extrabold text-center text-gray-900">Unlock Unlimited Eye Analysis!</h2>
            ...
            <div className="mt-6 text-center bg-gray-100 p-4 rounded-xl border border-gray-200">
                <p className="text-lg font-bold">Only <span className="text-indigo-600 text-2xl">$2 per week</span></p>
